...
class Wpyes {
	...
	protected function get_settings() {
		...
		return apply_filters( 'wpyes_' . $this->menu_slug . '_settings', $this->settings ); // @phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound
	}
				...
				<div class="wpyes-tab-wrapper metabox-holder">
					<?php foreach ( $this->settings_populated as $tab_key => $tab ) : ?>
						<div id="<?php echo esc_attr( $tab['id'] ); ?>" class="wpyes-tab-group">
							<?php do_action( 'wpyes_' . $this->menu_slug . '_setting_tab_' . $tab_key, $tab ); // @phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound ?>
						</div>
					<?php endforeach; ?>
				</div>
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		do_action( 'wpyes_' . $this->menu_slug . '_admin_enqueue_scripts', $hook, $this ); // @phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound
	}
	...
	public function admin_footer_js() {
		...
		do_action( 'wpyes_' . $this->menu_slug . '_admin_footer_js', $screen, $this ); // @phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound
	}
	...
	protected function humanize_slug( $slug ) {
		...
		$ignores = apply_filters( 'wpyes_humanize_slug_ignores', array( 'a', 'and', 'or', 'to', 'in', 'at', 'in', 'of' ) ); // @phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound
